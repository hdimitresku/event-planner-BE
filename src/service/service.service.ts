...
export class ServiceService {
    ...
    async findOptionById(id: string): Promise<ServiceOption> {
    ...
    async updateAvailability(
        ...
        const serviceOption = await this.serviceOptionRepository.findOne({where: {id}});

        await this.serviceOptionRepository.update(id, {
            metadata: {
                ...serviceOption?.metadata,
                blockedDates: [
                    ...(serviceOption?.metadata?.blockedDates || []),
                    {
                        startDate,
                        endDate,
                        isConfirmed,
